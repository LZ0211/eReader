...
class Hash extends EventEmitter{
    ...
    localization(){
        if(this.location){
            fs.writeFileSync(this.location,this.stringify())
        }
        return this
    }
    ...
    file(location){
        if(!this.location){
            ...
            process.on('exit',this.localization.bind(this))
            this.on('change',this.localization.bind(this))
        }
        this.location = location
        try{
